...
Plus the required elements:
- One block quote from the source article or operator
- One pull quote from Mason's own take
- The closer (60 to 100 words)
- The Quarry CTA (one line)
- Sign off with "— Mason"
...
Plus the required elements:
- One block quote from the source
- One pull quote from Mason's own take
- The closer (60 to 100 words)
- The Quarry CTA (one line)
- Sign off with "— Mason"
